 ...
 */
public class TheDarknessBeyondEngine {
	 ...
	 */
	private static TheDarknessBeyondEngine instance;
	/**
	 ...
	 */
	public static TheDarknessBeyondEngine getInstance() {
		return instance;
	}
	
	/**
	 * @return state of {@link TheDarknessBeyondEngine#running GameEngine.running}
	 */
	...
	public static void main(String[] args) {
		...
		instance = new TheDarknessBeyondEngine();
		instance.run();
	}
	 ...
	 */
	private TheDarknessBeyondEngine() {
		initialize();
	}
	...
	/**
	 * Short hand for {@link TheDarknessBeyondEngine#render(Graphics, ImageObserver)}, used
