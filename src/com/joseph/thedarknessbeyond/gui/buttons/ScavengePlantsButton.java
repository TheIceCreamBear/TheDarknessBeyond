...
public class ScavengePlantsButton extends AbstractButton {
	...
	public ScavengePlantsButton(int x, int y, String s) {
		this(x, y, s, null);
	}
	
	public ScavengePlantsButton(int x, int y, String s, ToolTip tt) {
		...
		// Sets a cooldown (timer) of 500 seconds on the ScavengePlantsButton
	...
	*/
	...
	// Can be disregarded, as a tooltip is not needed for the ScavengePlantsButton
	...
	/* While the ScanengePlantsButton is clicked, add 2 berries and 3 cotton to our storage, and set the cooldown to 500 seconds before being able to be clicked again.
