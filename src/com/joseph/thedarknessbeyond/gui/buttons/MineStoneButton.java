...
/**
 * mines stone and adds it to the stores
 * @author Justin
 *
 */
public class MineStoneButton extends AbstractButton {
	...
	public MineStoneButton(int x, int y, String s) {
		this(x, y, s, null);
	}
	
	public MineStoneButton(int x, int y, String s, ToolTip tt) {
		...
		// sets a cooldown (timer) of 1200 seconds on the MineStoneButton
	...
	*/
	...
	// Can be disregarded, as a tooltip is not needed for the MineStoneButton
	...
	/* While the MineStoneButton is clicked, add 10 stone to our storage, and set the cooldown to 1200 seconds before being able to be clicked again.
