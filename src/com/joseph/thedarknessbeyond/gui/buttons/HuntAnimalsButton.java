...
/**
 * hunts animals in the wilderness
 * @author Justin
 *
 */
public class HuntAnimalsButton extends AbstractButton {
	...
	public HuntAnimalsButton(int x, int y, String s) {
		this(x, y, s, null);
	}
	
	public HuntAnimalsButton(int x, int y, String s, ToolTip tt) {
		...
		// Set a cooldown (timer) of 800 seconds on the HuntAnimalsButton
	...
	*/
	...
	// Can disregard this, as tooltip is not needed for the HuntAnimalsButton
	...
	/* While the HuntAnimalsButton is clicked, add 3 fur and 4 meat to our storage, and set the cooldown to 800 seconds before being able to be clicked again.
